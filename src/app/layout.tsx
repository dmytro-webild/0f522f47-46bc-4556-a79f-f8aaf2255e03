...
export const metadata: Metadata = {
  title: "Professional Portfolio | Designer & Developer",  description: "Explore my portfolio of creative web design and development projects. Specializing in modern digital experiences and innovative solutions.",  keywords: "portfolio, web design, web development, designer, developer, projects, creative",  metadataBase: new URL("https://yourportfolio.com"),
  alternates: {
    canonical: "https://yourportfolio.com"},
  openGraph: {
    title: "Professional Portfolio | Designer & Developer",    description: "Explore my portfolio of creative web design and development projects.",    url: "https://yourportfolio.com",    siteName: "Your Portfolio",    type: "website",    images: [
      {
        url: "http://img.b2bpic.net/free-photo/close-up-portrait-young-handsome-successful-man_1163-5475.jpg",        alt: "Portfolio hero image"},
    ],
  },
  twitter: {
    card: "summary_large_image",    title: "Professional Portfolio | Designer & Developer",    description: "Explore my portfolio of creative web design and development projects.",    images: ["http://img.b2bpic.net/free-photo/close-up-portrait-young-handsome-successful-man_1163-5475.jpg"],
  },
  robots: {
    index: true,
    follow: true,
